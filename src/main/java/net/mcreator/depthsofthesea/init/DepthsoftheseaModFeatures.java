...
import net.mcreator.depthsofthesea.world.features.ores.HydrothermalVentFeature;
...
public class DepthsoftheseaModFeatures {
	private static final Map<Feature<?>, FeatureRegistration> REGISTRY = new HashMap<>();
	static {
		REGISTRY.put(HydrothermalVentFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.UNDERGROUND_ORES,
				HydrothermalVentFeature.GENERATE_BIOMES, HydrothermalVentFeature.CONFIGURED_FEATURE));
	}
